...
const VISIBLE_TABS = ["SeniorManagement","Requests", "HomePage", "Sensors", "Profile"];

export function CaretakerTabBar({
  state,
  descriptors,
  navigation,
  ...
  return (
    <View
      className="absolute bottom-10 left-12 right-12 bg-transparent shadow-lg shadow-black/10"
