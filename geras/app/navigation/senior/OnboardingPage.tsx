...
const SLIDES = [
  ...
  },
  {
    id: 2,
    title: 'Bem-Vindo',
    description: 'SINTA-SE MAIS\nSEGURO',
    materialIcon: 'health-and-safety',
  },
  {
    id: 3,
    title: 'Bem-Vindo',
    description: 'AJUDA À DISTÂNCIA\nDE UM BOTÃO',
    materialIcon: 'touch-app',
  },
  {
    id: 4,
    title: 'Bem-Vindo',
    description: 'CRIE UMA REDE PRÓXIMA DE CONFIANÇA',
    materialIcon: 'diversity-3',
  },
  {
    id: 5,
    title: 'Bem-Vindo',
    description: 'CONTE COM O APOIO\nDA COMUNIDADE',
    materialIcon: 'people',
  },
];
...
export default function OnboardingPage() {
  ...
  const completeOnboarding = async () => {
    ...
    try {
      ...
      // Refresh o perfil para que o index.tsx veja onboarding_completed=true
      // e redirecione para a HomePage correta do utilizador
      await refreshProfile();
      // Volta ao index que gere o redirect baseado no role + onboarding
  ...
  const renderCenterImage = () => {
    if (slide.isLogo) {
      // Slide 1: large logo + GERAS label
      return (
    ...
    if (slide.materialIcon) {
      // Slides 2+: icon inside white rounded card
      return (
      ...
      <SafeAreaView style={{ flex: 1 }} edges={['top', 'bottom']}>
        <View style={styles.container}>
          ...
          <View style={styles.imageWrapper}>
            {renderCenterImage()}
            {/* Slides 2+: description grouped right below the icon */}
            {!slide.isLogo && (
...
const styles = StyleSheet.create({
  ...
  /* Title */
  titleWrapper: {
    marginTop: 40, // brings title away from top notch area
    marginBottom: 0,
    alignItems: 'center',
  },
  title: {
