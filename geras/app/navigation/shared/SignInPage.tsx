        ...
        <View className="flex-1 justify-center">
          ...
          <View className="mb-6 items-center">
            <Svg
              ...
              accessibilityLabel="Logótipo Geras"
            >
          ...
          <View className="mb-6 mt-6 w-full items-center">
            <View className="w-full gap-y-4 px-8">
              <TextInput
                ...
                accessibilityHint="Introduza o seu nome completo"
              />
              ...
              <TextInput
                ...
                accessible={true}
                accessibilityLabel="Correio eletrónico"
                accessibilityHint="Introduza o seu endereço de email"
              />
